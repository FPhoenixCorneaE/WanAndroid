        ...
        for (i in destRects.indices) {
            ...
            if (!kidding) {
                ...
                canvas.clipRect(0,
                    0,
                    r.width(),
                    mStaticLayout!!.getLineBottom(lineCount - 1) - mStaticLayout!!.getLineTop(0))
    ...
    private val allYCors: Unit
        get() {
            ...
            for (i in 0 until cCount) {
                ...
                availableBottom =
                    if (availableBottom % lineHeight == 0) availableBottom else (availableBottom / lineHeight + 1) * lineHeight
